...
const SheetTitle = (props) => {
  const { className, ...rest } = props;
  return <SheetPrimitive.Title className={cn("text-lg font-semibold text-foreground", className)} {...rest} />;
};

const SheetDescription = (props) => {
  const { className, ...rest } = props;
  return <SheetPrimitive.Description className={cn("text-sm text-muted-foreground", className)} {...rest} />;
};
