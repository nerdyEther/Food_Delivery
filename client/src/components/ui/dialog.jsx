...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content ref={ref} className={cn("fixed left-[50%] top-[50%] max-w-lg translate-x-[-50%] translate-y-[-50%] border bg-background p-6 shadow-lg", className)} {...props}>
      {children}
